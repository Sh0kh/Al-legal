          ...
          >
            ...
            <div className="space-y-6">
              <p className="text-gray-700 leading-relaxed">
                At <span className="font-semibold text-red-600">AllLegal Uzbekistan</span>, we are more than a law firm — we are a partner in your 
                business's success. Our mission is to provide unparalleled legal expertise while 
                cultivating lasting relationships built on trust, dedication, and shared goals. We 
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                partnerships that drive success. <span className="font-semibold text-red-600">Local Stand, Global Presence</span> — this is our 
